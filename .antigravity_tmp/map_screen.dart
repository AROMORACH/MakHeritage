                ...
                onPressed: isProcessing ? null : () async {
                  ...
                  try {
                    ...
                    if (!isOtpSent) {
                      ...
                      // SEND OTP VIA SUPABASE natively!
                      ...
                      // VERIFY OTP VIA SUPABASE natively!
                      ...
                      if (_isAdminMode) ...[
                        ElevatedButton.icon(
                          ...
                          onPressed: () {
                            ...
                            Navigator.push(context, MaterialPageRoute(builder: (_) => EditLandmarkScreen(landmark: landmark)));
                          },
                        ),
                        OutlinedButton(
                          onPressed: () => setState(() => _isAdminMode = false),
                          child: const Text('Exit Admin Mode', style: TextStyle(color: Colors.red)),
                        )
                      ],
              ...
              children: [
                ...
                Positioned(
                  ...
                  child: FloatingActionButton(
                    ...
                    backgroundColor: _isMasterVolumeMuted ? Colors.grey : const Color(0xFFE5A93C),
                    onPressed: () {
                      setState(() {
                        _isMasterVolumeMuted = !_isMasterVolumeMuted;
                      });
                      if (_isMasterVolumeMuted) {
                        _flutterTts.stop();
                        ScaffoldMessenger.of(context).showSnackBar(
